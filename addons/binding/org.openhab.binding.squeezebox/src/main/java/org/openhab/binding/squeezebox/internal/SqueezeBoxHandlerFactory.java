...
import org.openhab.binding.squeezebox.discovery.SqueezeBoxPlayerDiscoveryService;
...
public class SqueezeBoxHandlerFactory extends BaseThingHandlerFactory {
	...
	private synchronized void registerSqueezeBoxPlayerDiscoveryService(
		...
		SqueezeBoxPlayerDiscoveryService discoveryService = new SqueezeBoxPlayerDiscoveryService(
