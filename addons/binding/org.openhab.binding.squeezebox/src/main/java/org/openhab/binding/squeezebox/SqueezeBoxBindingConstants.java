...
public class SqueezeBoxBindingConstants {
	...
	public final static ThingTypeUID SQUEEZEBOXPLAYER_THING_TYPE = new ThingTypeUID(
			BINDING_ID, "squeezeboxplayer");
	public final static ThingTypeUID SQUEEZEBOXSERVER_THING_TYPE = new ThingTypeUID(
			BINDING_ID, "squeezeboxserver");
