...
public class SqueezeBoxServerHandler extends BaseBridgeHandler {
	...
	private List<SqueezeBoxPlayerEventListener> squeezeBoxPlayerListeners = new CopyOnWriteArrayList<>();
	private Map<String, SqueezeBoxPlayer> players = new ConcurrentHashMap<String, SqueezeBoxPlayer>();
	...
	private void disconnect() {
		...
		try {
			...
			logger.error("Error attempting to disconnect from Squeeze Server",
					e);
			return;
		} finally {
			clientSocket = null;
...
//	 * @param event
//	 */
//	private void updateChildStatus(ThingStatus status) {
//		// update our children
//		Bridge bridge = getThing();
//		List<Thing> things = bridge.getThings();
//		for (Thing thing : things) {
